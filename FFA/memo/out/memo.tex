...
\includegraphics[width=0.8\linewidth]{FFA/memo/plots/ffasup}
\label{fig:ffasup}
}
...
\subfloat[FFA Loss]{
\includegraphics[width=0.32\linewidth]{FFA/memo/plots/lfunc0}
\label{fig:lfunc0}
}
\qquad
\subfloat[FFA Time to Position]{
\includegraphics[width=0.32\linewidth]{FFA/memo/plots/lfunc20}
\label{fig:lfunc20}
}
\qquad
\subfloat[FFA Loss over Time]{
\includegraphics[width=0.32\linewidth]{FFA/memo/plots/lfunc30}
\label{fig:lfunc30}
}
...
\subfloat[FFA Loss]{
\includegraphics[width=0.32\linewidth]{FFA/memo/plots/lfunc1}
\label{fig:lfunc1}
}
\qquad
\subfloat[FFA Time to Position]{
\includegraphics[width=0.32\linewidth]{FFA/memo/plots/lfunc21}
\label{fig:lfunc21}
}
\qquad
\subfloat[FFA Loss over Time]{
\includegraphics[width=0.32\linewidth]{FFA/memo/plots/lfunc31}
\label{fig:lfunc31}
}
...
\subfloat[FFA Loss]{
\includegraphics[width=0.32\linewidth]{FFA/memo/plots/lfunc2}
\label{fig:lfunc2}
}
\qquad
\subfloat[FFA Time to Position]{
\includegraphics[width=0.32\linewidth]{FFA/memo/plots/lfunc22}
\label{fig:lfunc22}
}
\qquad
\subfloat[FFA Loss over Time]{
\includegraphics[width=0.32\linewidth]{FFA/memo/plots/lfunc32}
\label{fig:lfunc32}
}
