...
\includegraphics[width=0.8\linewidth]{FDA/memo/plots/ffasup}
\label{fig:ffasup}
}
...
\subfloat[Base FDA Architecture]{
\includegraphics[width=0.8\linewidth]{FDA/memo/plots/fda}
\label{fig:fda}
}
...
\subfloat[Base FDA Architecture]{
\includegraphics[width=0.8\linewidth]{FDA/memo/plots/fda2}
\label{fig:fda2}
}
